...
import { getPlaceholderImage, getFirstCoord2D } from '../utils';
...
const DetailCard = memo(({ feature, onClose, onOpenCheckin, onOpenLogin }) => {
  ...
  const imageUrl = getPlaceholderImage(siteName);
  ...
  return (
    ...
    >
      ...
      <p className="text-sm text-gray-600 mt-1.5 leading-snug">
        Sitio histórico ubicado en {folder}. Descubre más sobre este lugar icónico
        de Acapulco y planifica tu visita.
      </p>
